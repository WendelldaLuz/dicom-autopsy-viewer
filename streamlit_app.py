...
def show_main_app():
    st.title(f"<i class='fa-solid fa-microscope'></i> {get_text('app_title')}", unsafe_allow_html=True)
        ...
        if dicom_file:
            try:
                ...
                try:
                    ...
                    with tab3:
                        st.markdown('<div class="card">', unsafe_allow_html=True)
                        st.subheader(f"<i class='fa-solid fa-user'></i> {get_text('patient_info_title')}", unsafe_allow_html=True)
                        patient_info = {
                    ...
                    with tab4:
                        st.markdown('<div class="card">', unsafe_allow_html=True)
                        st.subheader(f"<i class='fa-solid fa-gears'></i> {get_text('tech_info_title')}", unsafe_allow_html=True)
