                        ...
                        with st.form("feedback_form"):
                            ...
                            if submitted:
                                ...
                                if rating == 0:
                                    ...
                                    st.success(
                                        "Avaliação enviada com sucesso! Obrigado por contribuir com a melhoria do sistema.")
                                    st.balloons()  # Efeito visual de sucesso
                                    st.rerun()
                    else:
                        st.success(
                            "Obrigado pela sua avaliação! Suas contribuições são fundamentais para o aprimoramento contínuo do sistema.")
